...
}.values.flatten.reduce(&:merge).select{|k, v| v.includes? "BBQ"}             # => {:christmas=>["Lights", "Wreath"], :new_years=>["Party Hats"], :fourth_of_july=>["Fireworks", "BBQ"], :thanksgiving=>["Turkey"], :memorial_day=>["BBQ"]}
